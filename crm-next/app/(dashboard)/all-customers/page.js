...
import { deleteCustomer, updateCustomer, getAllCustomers } from '@/lib/api';
...
const AllCustomers = () => {
    ...
    const [isMobileView, setIsMobileView] = useState(false); // Default to false to avoid hydration mismatch
                            ...
                            <div className="mt-8 flex flex-col sm:flex-row items-center justify-between gap-4 bg-white rounded-lg border border-gray-200 p-4">
                                ...
                                <div className="flex items-center gap-2">
                                    <button
                                        ...
                                        className={`px-3 py-2 rounded-lg font-medium text-sm transition-all ${currentPage === 1
                                    ...
                                    <button
                                        ...
                                        className={`px-3 py-2 rounded-lg font-medium text-sm transition-all ${currentPage === totalPages
                                            ? 'bg-gray-100 text-gray-400 cursor-not-allowed'
                                            : 'bg-white text-gray-700 border border-gray-300 hover:bg-gray-50 hover:border-gray-400'
                                            }`}
                                    >
                        ...
                        <div className="bg-white rounded-xl shadow-2xl w-full max-w-sm">
                            ...
                            <div className="p-6 text-center">
                                ...
                                <p className="text-gray-600 text-sm">
                                    Do you really want to delete <span className="font-bold text-gray-900">{customerToDelete.userName}</span>? This process cannot be undone.
                                </p>
                            </div>
