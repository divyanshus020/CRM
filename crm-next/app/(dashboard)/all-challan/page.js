...
import { deleteChallan, getAllChallans } from '@/lib/api';
        ...
        <div className="p-8 bg-gray-50 min-h-screen">
            <header className="flex justify-between items-center mb-8">
                ...
                <div className="flex space-x-2">
                    ...
                    <button onClick={() => router.push('/new-challan')} className="flex items-center space-x-2 px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700">
                        <Plus size={20} />
                        ...
                        <tbody>
                            {currentItems.map(challan => (
                                <tr key={challan._id} className="border-b hover:bg-gray-50">
                                    ...
                                    <td className="p-4">
                                        <div className="flex space-x-2">
                                            <button onClick={() => router.push(`/view/${challan._id}`)} className="p-2 text-gray-500 hover:text-blue-600"><Edit size={18} /></button>
