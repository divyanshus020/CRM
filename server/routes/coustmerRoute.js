...
import { createCustomer, deleteCustomer, editCustomer, getAllCustomers } from "../controller/coustmerController.js"
...
router.route("/delete-coustmer/:id").delete(isAuthntiacted, deleteCustomer)
